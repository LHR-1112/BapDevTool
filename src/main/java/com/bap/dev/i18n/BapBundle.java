...
public final class BapBundle extends DynamicBundle {
    @NonNls
    public static final String BUNDLE = "messages.BapBundle"; // 对应 resources 下的路径

    private static final BapBundle INSTANCE = new BapBundle();
